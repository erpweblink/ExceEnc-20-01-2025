paid = string.Empty; static string lbltotlaclients = string.Empty;
    ...
    private void GvLoginLogBind()
    {
        ...
        {
            query = @"select * from ExcelEncLive.tblLoginLogs where LoginDate=CONVERT(date, getdate()) order by id desc";
        }
        else
        {
            ...
            query = @"select * from ExcelEncLive.tblLoginLogs where LoginDate='" + str + "' order by id desc";
        }
