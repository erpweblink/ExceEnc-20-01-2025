#pragma checksum "E:\Ashish\User Autorization Excel Enc 21-11-22\Admin\ProformaInvoicePDF.aspx.cs" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4B4D5B16E472EB3B72910A0D12ADF4FFC3181A5A"

#line 1 "E:\Ashish\User Autorization Excel Enc 21-11-22\Admin\ProformaInvoicePDF.aspx.cs"
using System;
...
public partial class Admin_ProformaInvoicePDF : System.Web.UI.Page
{
    ...
    protected void Pdf(string flg)
    {
        ...
        if (Dt.Rows.Count > 0)
        {
            ...
            string Amtinword = ConvertNumbertoWords(Convert.ToInt32(Totalamtfff), CurrencyType);
