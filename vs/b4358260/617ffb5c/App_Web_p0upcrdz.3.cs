#pragma checksum "E:\Ashish\User Autorization Excel Enc 21-11-22\Admin\Receipt.aspx.cs" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "59D8F807971C7C1F392C2993DC0E758E0B3103F9"

#line 1 "E:\Ashish\User Autorization Excel Enc 21-11-22\Admin\Receipt.aspx.cs"
using System;
...
public partial class Admin_Receipt : System.Web.UI.Page
{
    ...
    public void fnInsert()
    {
        ...
        try
        {
            ...
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Data Saved Sucessfully');window.location.href='Receipt.aspx';", true);
        }
        catch (Exception)
        {
    ...
    protected void Calculation(GridViewRow row)
    {
        ...
        TextBox lblrecvd = (TextBox)row.FindControl("lblrate");
    ...
    protected void Gvreceipt_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (btnsubmit.Text != "Update")
            {
                ...
                Label lblinvoiceno = (Label)e.Row.FindControl("lblinvoiceno");
                SqlCommand cmdmax = new SqlCommand("SELECT Max(CAST(Recvd as float)) FROM tblReceiptDtls where InvoiceNo='" + lblinvoiceno.Text + "'", con);
                con.Open();
                Object Recvdval = cmdmax.ExecuteScalar();
                con.Close();
