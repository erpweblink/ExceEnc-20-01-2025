#pragma checksum "E:\Ashish\User Autorization Excel Enc 21-11-22\Admin\TestCertificate.aspx.cs" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "86618417C55B2C9D13B8E3753F4FA59B44103776"

#line 1 "E:\Ashish\User Autorization Excel Enc 21-11-22\Admin\TestCertificate.aspx.cs"
using System;
    ...
    protected void btnGenerate_Click(object sender, EventArgs e)
    {
        try
        {
            if (ValidateData() == true)
            {
                ...
                cmdInsert.Parameters.AddWithValue("@CreatedBy", Session["ProductionName"].ToString());
                ...
                string modified_URL = "window.open('TestCertificatePDF.aspx', '_blank');";
                ScriptManager.RegisterStartupScript(this, typeof(string), "OPEN_WINDOW", modified_URL, true);
                //ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('SUCCESS- Test Certificate Generated Successfully...!');window.location.href='TestCertificate.aspx';", true);
            }
        }
        catch (Exception)
        {
