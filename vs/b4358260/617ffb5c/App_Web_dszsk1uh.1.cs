#pragma checksum "E:\Ashish\User Autorization Excel Enc 21-11-22\Admin\PurchaseOrder.aspx.cs" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0AFE612EECF36E96CE02CB4DBFE700CA909F9F72"

#line 1 "E:\Ashish\User Autorization Excel Enc 21-11-22\Admin\PurchaseOrder.aspx.cs"
using System;
...
public partial class Admin_PurchaseOrder : System.Web.UI.Page
{
    ...
    protected void Send_Mail(int? Id, string Subject)
    {
        string strMessage = "Hello " + txtSupplierName.Text.Trim() + "<br/>" +
                        ...
                        "We have sent you Purchase Order." + "<br/>" +
        ...
        string pdfname = txtPONo.Text + "_" + txtSupplierName.Text + "_" + txtPodate.Text + ".pdf";
