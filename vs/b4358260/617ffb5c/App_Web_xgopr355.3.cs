#pragma checksum "E:\Ashish\User Autorization Excel Enc 21-11-22\Admin\PaymentPDF.aspx.cs" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "AA39F0E316A5B50F579CB389C1265A259B789B79"

#line 1 "E:\Ashish\User Autorization Excel Enc 21-11-22\Admin\PaymentPDF.aspx.cs"
using System;
...
public partial class Admin_PaymentPDF : System.Web.UI.Page
{
    string id;
    ...
    protected void Pdf(string id)
    {
        ...
        if (Dt.Rows.Count > 0)
        {
            ...
            cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 11);
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "Mb No : 9225805669/9225814668   EMAIL : purchase@excelenclosures.com ", 158, 772, 0);
			cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "accounts@excelenclosures.com ", 357, 762, 0);
            cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 11);
    ...
    {
        string EmailID = "";
        SqlDataAdapter ad = new SqlDataAdapter("SELECT [EmailID] FROM [tblSupplierMaster] where SupplierName='" + SupplierName.Trim() + "' ", con);
        DataTable dt = new DataTable();
        ad.Fill(dt);
        if (dt.Rows.Count > 0)
        {
