#pragma checksum "E:\Ashish\User Autorization Excel Enc 21-11-22\Admin\TaxInvoice.aspx.cs" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4CD5E3693E4E107922E96311D040C4CB99C9F972"

#line 1 "E:\Ashish\User Autorization Excel Enc 21-11-22\Admin\TaxInvoice.aspx.cs"
using System;
...
public partial class Admin_TaxInvoice : System.Web.UI.Page
{
	  ...
	  public string GenerateExportInvoiceCode()
    {
        ...
        if (result != "")
        {
            ...
            {
                numbervalue = numbervalue + 1;
                strInvoiceNumber = previousyear.ToString() + "-" + FinYear + "/" + numbervalue.ToString("00");
            }
            else
            {
                numbervalue = numbervalue + 1;
