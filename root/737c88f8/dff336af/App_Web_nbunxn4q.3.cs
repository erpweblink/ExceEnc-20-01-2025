#pragma checksum "E:\Ashish\User Autorization Excel Enc 21-11-22\Admin\AuditLogDashboard.aspx.cs" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "E421F9DC899C082D613541352EDF1BA4A17EA6BE"

#line 1 "E:\Ashish\User Autorization Excel Enc 21-11-22\Admin\AuditLogDashboard.aspx.cs"
using System;
...
public partial class Admin_AuditLogDashboard : System.Web.UI.Page
{
    ...
    //    cmd.Parameters.AddWithValue("@Date", txtDate.Text == "" ? (object)DBNull.Value : txtFromDate1.Text);
    ...
    void GvOrderAcceptanceListBind()
    {
        ...
        cmd.Parameters.AddWithValue("@ActionName", "OAList");
        cmd.Connection = con;
        con.Open();
        try
        {
