#pragma checksum "E:\Ashish\User Autorization Excel Enc 21-11-22\Admin\PurchaseOrderPDF.aspx.cs" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "F93D66180E2120F5B65766B9E2B6EB07A9347E17"

#line 1 "E:\Ashish\User Autorization Excel Enc 21-11-22\Admin\PurchaseOrderPDF.aspx.cs"
using System;
...
public partial class Admin_PurchaseOrderPDF : System.Web.UI.Page
{
    ...
    private void Pdf()
    {
        ...
        SqlDataAdapter Da = new SqlDataAdapter("select * from vw_PurchaseOrder where Id = '" + Session["PDFID"].ToString() + "'", con);
        ...
        cbbb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
        cbbb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "EMAIL : purchase@excelenclosures.com", 280, 720, 0);
        cbbb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
        cbbb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "CONTACT : 9225805669", 455, 720, 0);
        cbbb.EndText();
        ...
        cd.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "Purchase Order", 270, 693, 0);
        cd.EndText();
