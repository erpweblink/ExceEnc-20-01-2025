#pragma checksum "E:\Ashish\User Autorization Excel Enc 21-11-22\Admin\PurchaseBillPDF.aspx.cs" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1A83AFEAAD7D1E4AC6D8D12962F3D9E2C082A109"

#line 1 "E:\Ashish\User Autorization Excel Enc 21-11-22\Admin\PurchaseBillPDF.aspx.cs"
using System;
    ...
    private void Pdf()
    {
        ...
        if (Dt.Rows.Count > 0)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                SqlCommand cmd = new SqlCommand("select ContactNo from tblSupplierContactDtls where HeaderID='" + Id + "'", con);
                con.Open();
                Object cont = cmd.ExecuteScalar();
                if (cont == null)
                {
                    contNo = "";
                }
