#pragma checksum "E:\Ashish\User Autorization Excel Enc 21-11-22\Admin\TaxInvoicePDF.aspx.cs" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4C8D8C4297975329F27BB16E5460050FD9892ECA"

#line 1 "E:\Ashish\User Autorization Excel Enc 21-11-22\Admin\TaxInvoicePDF.aspx.cs"
using System;
        ...
        if (Dt.Rows.Count > 0)
        {
           ...
           string GSTNo = "";
            ...
            if (flg == "Original")
            {
                ...
                cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "ORIGINAL FOR BUYER", 480, 690, 0);
            }
            else if (flg == "Duplicate")
            {
                cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
                cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "DUPLICATE FOR TRANSPORTER", 450, 690, 0);
            }
            else if (flg == "Triplicate")
            {
                cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
                cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "TRIPLICATE FOR SUPPLIER", 470, 690, 0);
            }
            else if (flg == "Extra")
            {
                cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
                cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "EXTRA COPY", 480, 690, 0);
            }
