<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="CNCBending.aspx.cs" Inherits="Admin_CNCBending" %>
    ...
    <script type="text/javascript">
        ...
        function CheckedCheckbox(ob) {
            ...
            if (checkboxval == true) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'CNCBending.aspx/MakeSessionNull',
                    data: '{}',
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            ...
                            <div class="row" style="padding: 10px;">
                                ...
                                <div class="page-header-breadcrumb">
                                    <div style="float: right; margin: 3px; margin-bottom: 5px;">
                                        <span id="btncncbendingoldlist" runat="server"><a href="CNCBending_OldDB.aspx" style="font-size: 16px; border: 1px dashed gray; padding: 4px;">&nbsp;CNC BENDING OLD DATA</a>&nbsp;&nbsp;
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12" style="padding: 30px;">
                                    <div id="DivRoot" align="left">
                                        ...
                                        <div style="overflow: auto; position: relative; top: 0px; vertical-align: top;" class="dt-responsive table-responsive" onscroll="OnScrollDiv(this)" id="DivMainContent">
                                            <asp:GridView ID="dgvCNCBending" runat="server" CssClass="table table-striped table-bordered nowrap"
                                                AutoGenerateColumns="false" DataKeyNames="SubOA" OnRowCommand="dgvCNCBending_RowCommand" OnRowDataBound="dgvCNCBending_RowDataBound">
                                                <Columns>
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                        <ItemTemplate>
                                                            <a href="<%#string.Format("../Reports/ReportPDF.aspx?Dept="+encrypt("CNC Bending")+"&OANumberWise={0}", encrypt(Eval("OANumber").ToString())) %>" target="_blank">
                                                    ...
                                                    <asp:TemplateField HeaderText="Return Qty" ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            ...
                                                            &nbsp;&nbsp;
                                                            <asp:LinkButton ID="btnRemark" runat="server" CommandName="RowComment" CommandArgument='<%# Eval("CNCBendingId") %>' ToolTip="Add Remark"><i class="fa fa-comment" style="font-size: 25px!important" aria-hidden="true"></i></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
            ...
            <asp:Panel ID="PnlCreateQuot" runat="server" CssClass="modelprofile1">
                <div class="row container">
                    ...
                    <div class="col-md-7">
                     ...
                     <button type="button" id="CloseCreatedetail" class="btnclose" style="display: inline-block;" data-dismiss="modal" onclick="window.location='CNCBending.aspx';">CANCEL</button></h4>
                            </div>
                            <br />
        ...
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="dgvCNCBending" />
