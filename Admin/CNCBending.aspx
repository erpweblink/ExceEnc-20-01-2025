                                            ...
                                            <asp:GridView ID="dgvCNCBending" runat="server" CssClass="table table-striped table-bordered nowrap"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Outward DateTime" ItemStyle-Width="100" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtOutwardDtTime" Width="100" runat="server" ReadOnly="false" CssClass="form-control myDate"></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Return Qty" ItemStyle-Width="60" ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
