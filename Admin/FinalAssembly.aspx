<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="FinalAssembly.aspx.cs" Inherits="Admin_FinalAssembly" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function ShowPopup() {
            ...
            $.ajax({
                type: 'POST',
                url: 'FinalAssembly.aspx/MakeSessionNull',
                data: '{}',
        ...
        function CheckedCheckbox(ob) {
            ...
            var grid = document.getElementById("<%=dgvFinalAssembly.ClientID%>");
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <div class="page-wrapper">
                                ...
                                <div class="col-md-12" style="padding: 30px;">
                                    <div id="DivRoot" align="left">
                                        ...
                                        <div style="overflow: auto; position: relative; top: 0px; vertical-align: top;" class="dt-responsive table-responsive" onscroll="OnScrollDiv(this)" id="DivMainContent">
                                            <asp:GridView ID="dgvFinalAssembly" runat="server" CssClass="table table-striped table-bordered nowrap"
                                                AutoGenerateColumns="false" DataKeyNames="SubOA" OnRowCommand="dgvFinalAssembly_RowCommand" OnRowDataBound="dgvFinalAssembly_RowDataBound">
                                                <Columns>
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Inward Date Time" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                        <ItemTemplate>
                                                            <a href="<%#string.Format("../Reports/ReportPDF.aspx?Dept="+encrypt("Final Assembly")+"&OANumberWise={0}", encrypt(Eval("OANumber").ToString())) %>" target="_blank">
                                                    ...
                                                    <asp:TemplateField HeaderText="Return Qty" ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            ...
                                                            &nbsp;&nbsp;
                                                            <asp:LinkButton ID="btnRemark" runat="server" CommandName="RowComment" CommandArgument='<%# Eval("FinalAssemblyId") %>' ToolTip="Add Remark"><i class="fa fa-comment" style="font-size: 25px!important" aria-hidden="true"></i></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
                ...
                <asp:Panel ID="PnlCreateQuot" runat="server" CssClass="modelprofile1">
                    <div class="row container">
                      ...
                      <button type="button" id="CloseCreatedetail" class="btnclose" style="display: inline-block;" data-dismiss="modal" onclick="window.location='FinalAssembly.aspx';">CANCEL</button></h4>
                                </div>
                                <br />
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="txtCustomerNameNew" />

            <asp:PostBackTrigger ControlID="dgvFinalAssembly" />
