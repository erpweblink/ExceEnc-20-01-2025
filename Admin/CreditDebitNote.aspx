<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="CreditDebitNote.aspx.cs" Inherits="Admin_CreditDebitNote" %>
                        ...
                        <div class="col-md-5">
                            <div class="page-header-breadcrumb">
                                <div style="float: right; margin: 3px; margin-bottom: 5px;">
                                    <span><a href="CreditDebitNoteList.aspx" style="font-size: 16px; border: 1px dashed gray; padding: 4px;">&nbsp;Credit/Debit Note List</a>&nbsp;&nbsp;
                                    </span>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <center>
                                                            <div class="col-md-8">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <asp:TextBox ID="txtFGrandTot" CssClass="form-control" runat="server" Width="100%" ReadOnly="true"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                                </center>
                                                </div>
