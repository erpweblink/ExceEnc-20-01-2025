<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="EWayBillList_CrDbNote.aspx.cs" Inherits="Admin_EWayBillList_CrDbNote" %>
            ...
            <div class="container py-3">
                <div class="card">
                    <div class="card-header bg-primary text-uppercase text-white">
                        <div class="row">
                            <div class="col-md-12">
                                <h5>E-WAY BILL List (From Credit/Debit Note)</h5>
                            </div>
                        </div>
                    </div>
                    <div class="row">
