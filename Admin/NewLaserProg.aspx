<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="NewLaserProg.aspx.cs" Inherits="Admin_NewLaserProg" %>
                        ...
                        <div class="card">
                            ...
                            <div class="row" style="padding: 10px;">
                                ...
                                <div class="col-md-6">
                                 ...
                                 <div class="page-header-breadcrumb">
                                        <div style="float: right; margin: 3px; margin-bottom: 5px;">
                                            <span id="btndrawinglist" runat="server"><a href="LaserProgramming_OldDB.aspx" style="font-size: 16px; border: 1px dashed gray; padding: 4px;">&nbsp;LASER PROGRAMMING OLD DATA</a>&nbsp;&nbsp;
                                            </span>
                                ...
                                <div class="col-md-2" id="btnshowhide">
                                    <asp:LinkButton ID="btnGetSelected" runat="server" CssClass="btn btn-small btn-primary" OnClick="GetSelectedRecords" Visible="false" OnClientClick="Confirm()"><i class="fa fa-angle-double-right"></i>&nbsp;Approve & Send</asp:LinkButton>
                                    <asp:Button ID="btnGetSelectedNew" CssClass="btn btn-small btn-primary" runat="server" Text="Approve & Send" OnClick="btnGetSelectedNew_Click" />
                                    <%--fa fa-send-o--%>
                                </div>
                                <div class="col-md-1">
                                </div>
                                    ...
                                    <div id="DivRoot" align="left">
                                        ...
                                        <div style="overflow: scroll;" class="dt-responsive table-responsive" onscroll="OnScrollDiv(this)" id="DivMainContent">
                                            <asp:GridView ID="dgvLaserprogram" runat="server" CssClass="table table-striped table-bordered nowrap"
                                                AutoGenerateColumns="false" DataKeyNames="LaserProgId" OnRowCommand="dgvLaserprogram_RowCommand" OnRowDataBound="dgvLaserprogram_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Customer Name" ItemStyle-Width="150" ItemStyle-HorizontalAlign="Center" Visible="true">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:TextBox runat="server" ID="lblCustName" ReadOnly="true" TextMode="MultiLine" Rows="4" Width="100%" CssClass="form-control" Text='<%# Eval("CustomerName").ToString().Replace("<br>", " ") %>'></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
