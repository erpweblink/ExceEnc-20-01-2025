...
public partial class Admin_TaxInvoicePDF : System.Web.UI.Page
{
    ...
    //    string imagecancel = Server.MapPath("~/img/CancelInvoice.png");
    ...
    //                Paymentterm = dtgstno.Rows[0]["paymentterm1"].ToString();
    ...
    //        cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "Gat No. 1567, Shelar Vasti, Dehu-Alandi Road, Chikhali, Pune - 411062", 165, 760, 0);
    //        cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 11);
    //        cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "EMAIL : excelenclosures@mail.com", 250, 745, 0);
    //        cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 11);
    ...
    //        cbbb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "GSTIN :27ATFPS1959J1Z4" + "", 48, 715, 0);
    //        cbbb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
    //        cbbb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "PAN NO: ATFPS1959J" + "", 170, 715, 0);
    //        cbbb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
    //        cbbb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "MAHARASHTRA STATE GST CODE : 27" + "", 280, 715, 0);
    //        cbbb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
    //        cbbb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "CONTACT : 9225658662", 455, 715, 0);
    //        cbbb.EndText();
    ...
    //    png1.ScaleToFit(70, 100);

    //    //For Image Position
    //    png1.SetAbsolutePosition(40, 750);
    //    //var document = new Document();
    ...
    //        cb1.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "Excel Enclosures", 250, 778, 0);
    //        cb1.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 11);
    //        cb1.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "Gat No. 1567, Shelar Vasti, Dehu-Alandi Road, Chikhali, Pune - 411062", 165, 760, 0);
    //        cb1.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 11);
    //        cb1.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "EMAIL : excelenclosures@mail.com", 250, 745, 0);
    //        cb1.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 11);
    ...
    //        cbbb1.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "GSTIN :27ATFPS1959J1Z4" + "", 48, 715, 0);
    //        cbbb1.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
    //        cbbb1.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "PAN NO: ATFPS1959J" + "", 170, 715, 0);
    //        cbbb1.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
    //        cbbb1.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "MAHARASHTRA STATE GST CODE : 27" + "", 280, 715, 0);
    //        cbbb1.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
    //        cbbb1.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "CONTACT : 9225658662", 455, 715, 0);
    //        cbbb1.EndText();
    ...
    protected void Pdf()
    {
        ...
        if (Dt.Rows.Count > 0)
        {
            ...
            if (dr1.Read())
            {
                ...
                string Description1 = dr1["ChargesDescription"].ToString();
                var amt = dr1["Basic"].ToString();
                double FBasicpf = Convert.ToDouble(dr1["Basic"].ToString());
                ...
                ValueOFSupply = Convert.ToDecimal(Ttotal_price) + Convert.ToDecimal(FBasicpf);
                CGStTotal = Convert.ToDecimal(CGST_price) + Convert.ToDecimal(cgstamt1);
                SGStTotal = Convert.ToDecimal(SGST_price) + Convert.ToDecimal(sgstamt1);
                IGStTotal = Convert.ToDecimal(IGST_price) + Convert.ToDecimal(igstamt1);
                TotalAmount = Convert.ToDecimal(Ftotal) + Convert.ToDecimal(GrandTotal1);
            ...
            string amount1 = Ttotal_price1.ToString();
            decimal GrandTotalFinal_Amt = Convert.ToDecimal(TotalAmount) + Convert.ToDecimal(TCSAmt);
            paragraphTable4.Add(table);
            doc.Add(paragraphTable4);
            ...
            PdfPCell cell440448 = new PdfPCell(new Phrase(GrandTotalFinal_Amt.ToString("#0.00"), FontFactory.GetFont("Arial", 9, Font.BOLD)));
            cell440448.HorizontalAlignment = Element.ALIGN_RIGHT;
            table.AddCell(cell440448);
            doc.Add(table);
            ///end Total InNumber
            ...
            table.AddCell(cell443457);
            //PdfPCell cell44044 = new PdfPCell(new Phrase(FinaleTotalamt.ToString(), FontFactory.GetFont("Arial", 10, Font.BOLD)));
            PdfPCell cell44044 = new PdfPCell(new Phrase(GrandTotalFinal_Amt.ToString("#0.00"), FontFactory.GetFont("Arial", 10, Font.BOLD)));
            cell44044.HorizontalAlignment = Element.ALIGN_LEFT;
            table.AddCell(cell44044);
            doc.Add(table);
            ///end Total Amount
