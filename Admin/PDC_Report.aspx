<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="PDC_Report.aspx.cs" Inherits="Admin_OutstandingReport_List" EnableEventValidation="false" %>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-md-3">
                                            <div class="spancls">Check Against<i class="reqcls">&nbsp;</i> :</div>
                                        <asp:DropDownList CssClass="form-control" ID="ddlgainst" runat="server" OnSelectedIndexChanged="ddlgainst_SelectedIndexChanged" AutoPostBack="true">
                                            <asp:ListItem Text="Select" Value="0"   Selected="True"></asp:ListItem>
                                            <asp:ListItem Text="From_Date & To_Date" Value="1"></asp:ListItem>
                                            <asp:ListItem Text="cheque_Date" Value="2"></asp:ListItem>
                                        </asp:DropDownList> 
                                        ...
                                        <div class="col-xl-3 col-md-3" runat="server" id="dvFromdate" visible="false">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-3 col-md-3" id="dvTodate" runat="server" visible="false">
                                        ...
                                        <div class="col-xl-3 col-md-3"  runat="server" id="dvchecquedate" visible="false">
                                            <div class="spancls">cheque Date<i class="reqcls">&nbsp;</i> :</div>
                                            <asp:TextBox ID="txtchqdate" runat="server" CssClass="form-control" placeholder="To Date" Width="100%" AutoComplete="off" TextMode="Date"></asp:TextBox>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12" style="padding: 0px; margin-top: 10px;">
                                        <div id="DivRoot" align="left">
                                            ...
                                            <div style="overflow: scroll;" class="dt-responsive table-responsive" onscroll="OnScrollDiv(this)" id="DivMainContent">
                                                <asp:GridView ID="GV_PDCReport" runat="server" DataKeyNames="BillNo" OnRowDataBound="GV_PDCReport_RowDataBound"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Invoice Amt." ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblInvoiceAmt" runat="server" Text='<%# Eval("InvoiceAmt") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                        <asp:TemplateField HeaderText="PDC Rcvd Date" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblPDC_RcvdDate" runat="server" Text='<%# Eval("PDC_RcvdDate", "{0:dd-MM-yyyy}") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                        <asp:TemplateField HeaderText="PDC Amt." ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblPDCAmt" runat="server" Text='<%# Eval("PDCAmt") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                        <asp:TemplateField HeaderText="PDC Cheque Date" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblPDC_ChequeDate" runat="server" Text='<%# Eval("PDC_ChequeDate") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                        <asp:TemplateField HeaderText="PDC Against" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblPDC_Against" runat="server"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                        <asp:TemplateField HeaderText="Mode Description" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
