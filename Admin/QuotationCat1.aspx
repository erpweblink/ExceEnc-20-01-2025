                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" style="display: inline;">
                                                ...
                                                <asp:TextBox ID="txtJbweldedmainbodycat" runat="server" Height="23px" Placeholder="Thickness"></asp:TextBox>
                                            </div>
                                        </div>
                                        <%--4--%>
                                        <br />
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" style="display: inline;">
                                                ...
                                                <asp:TextBox ID="txtQty" runat="server" Height="23px" Placeholder="Qty"></asp:TextBox>
                                            </div>
                                        </div>
                                        <%--6--%>
                                        <br />
                                ...
                                <div class="row" style="margin-right: 10px!important; margin-left: 10px; padding: 3px; border: 1px solid #ccc; border-radius: 3px;">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" style="display: inline;">
                                                <h5 style="font-size: 14px; font-weight: 700; color: black; display: inline;">10.&nbsp;</h5>
                                                <asp:CheckBox ID="checkboxInnerdoorforMCBOX30" Text="Inner Door" CssClass="myClass" runat="server" />

                                                <asp:DropDownList ID="ddlInnerdoor1forMCBOX30" runat="server">
                                                    <asp:ListItem>Select</asp:ListItem>
                                                    <asp:ListItem>Single</asp:ListItem>
                                                    <asp:ListItem>Split</asp:ListItem>
                                                </asp:DropDownList>

                                                <asp:DropDownList ID="ddlInnerdoorThicknessforMCBOX30" runat="server">
                                                    <asp:ListItem>Select Thickness</asp:ListItem>
                                                    <asp:ListItem>1.2mm</asp:ListItem>
                                                    <asp:ListItem>1.5mm</asp:ListItem>
                                                    <asp:ListItem>2.00mm</asp:ListItem>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" style="display: inline;">
                                                <h5 style="font-size: 14px; font-weight: 700; color: black; display: inline;">18.&nbsp;</h5>
                                                <asp:CheckBox ID="ChkWMM30fan" Text="Filter" CssClass="myClass" runat="server" />
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12" style="display: inline;">
                                        ...
                                        <asp:TextBox ID="txtmsfqty" runat="server" Height="23px" Placeholder="Qty"></asp:TextBox>
                                    </div>
                                </div>
                                <%--12--%>
                                <br />
                                ...
                                <div class="row">
                                    <div class="col-md-12" style="display: inline;">
                                        ...
                                        <asp:DropDownList ID="ddllistforshitMfs" runat="server">
                                            <asp:ListItem>Select</asp:ListItem>
                                            <asp:ListItem>Glass</asp:ListItem>
                                            <asp:ListItem>Acrylic</asp:ListItem>
                                            <asp:ListItem>Polycarbonate Sheet</asp:ListItem>
                                ...
                                <div class="row">
                                    <div class="col-md-12" style="display: inline;">
                                        <h5 style="font-size: 14px; font-weight: 700; color: black; display: inline;">18.&nbsp;</h5>
                                        <asp:CheckBox ID="ChkWMM23TransparentDoorMFS" Text="Transparent Door" CssClass="myClass" runat="server" />
                                        <asp:DropDownList ID="ddlWMM23TransparentDoorcat1MFS1" runat="server">
                                            <asp:ListItem>Select</asp:ListItem>
                                            <asp:ListItem>Glass</asp:ListItem>
                                            <asp:ListItem>Acrylic</asp:ListItem>
                                            <asp:ListItem>Polycarbonate</asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:DropDownList ID="ddlWMM23TransparentDoorcat2MFS" runat="server">
                                            <asp:ListItem>Select Thickness</asp:ListItem>
                                            <asp:ListItem>3.00mm</asp:ListItem>
                                            <asp:ListItem>4.00mm</asp:ListItem>
                                            <asp:ListItem>5.00mm</asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:DropDownList ID="ddlWMM23TransparentDoorcat3MFS" runat="server">
                                            <asp:ListItem>Select</asp:ListItem>
                                            <asp:ListItem>With bidding</asp:ListItem>
                                            <asp:ListItem>biddingless technique</asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <div class="row">
                                    <div class="col-md-12" style="display: inline;">
                                        ...
                                        <asp:CheckBox ID="ChkMFSfan" Text="Filter" CssClass="myClass" runat="server" />
                        ...
                        <div class="row" style="margin-right: 10px!important; margin-left: 10px; padding: 3px; border: 1px solid #ccc; border-radius: 3px;">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12" style="display: inline;">
                                        <h5 style="font-size: 14px; font-weight: 700; color: black; display: inline;">8.&nbsp;</h5>
                                        <asp:CheckBox ID="checkboxinnerdoorEcomc" Text="Inner Door" CssClass="myClass" runat="server" />

                                        <asp:DropDownList ID="ddlmat" runat="server">
                                            <asp:ListItem>Select</asp:ListItem>
                                            <asp:ListItem>Single</asp:ListItem>
                                            <asp:ListItem>Split</asp:ListItem>
                                        </asp:DropDownList>

                                        <asp:DropDownList ID="ddlthicknessforinnerdoor" runat="server">
                                            <asp:ListItem>Select Thickness</asp:ListItem>
                                            <asp:ListItem>1.5mm</asp:ListItem>
                                            <asp:ListItem>2.00mm</asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <div class="row">
                                    <div class="col-md-12" style="display: inline;">
                                        ...
                                        <asp:DropDownList ID="ddlEcoMCCbaseshits" runat="server">
                                            <asp:ListItem>Select</asp:ListItem>
                                            <asp:ListItem>Glass</asp:ListItem>
                                            <asp:ListItem>Acrylic</asp:ListItem>
                                            <asp:ListItem>Polycarbonate Sheet</asp:ListItem>
                                ...
                                <div class="row">
                                    <div class="col-md-12" style="display: inline;">
                                        <h5 style="font-size: 14px; font-weight: 700; color: black; display: inline;">15.&nbsp;</h5>
                                        <asp:CheckBox ID="ChkWMM23TransparentDoorEcoframe" Text="Transparent Door" CssClass="myClass" runat="server" />
                                        <asp:DropDownList ID="ddlWMM23TransparentDoorcat1Ecoframe" runat="server">
                                            <asp:ListItem>Select</asp:ListItem>
                                            <asp:ListItem>Glass</asp:ListItem>
                                            <asp:ListItem>Acrylic</asp:ListItem>
                                            <asp:ListItem>Polycarbonate</asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:DropDownList ID="ddlWMM23TransparentDoorcat2Ecoframe" runat="server">
                                            <asp:ListItem>Select Thickness</asp:ListItem>
                                            <asp:ListItem>3.00mm</asp:ListItem>
                                            <asp:ListItem>4.00mm</asp:ListItem>
                                            <asp:ListItem>5.00mm</asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:DropDownList ID="ddlWMM23TransparentDoorcat3Ecoframe" runat="server">
                                            <asp:ListItem>Select</asp:ListItem>
                                            <asp:ListItem>With bidding</asp:ListItem>
                                            <asp:ListItem>biddingless technique</asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <div class="row">
                                    <div class="col-md-12" style="display: inline;">
                                        <h5 style="font-size: 14px; font-weight: 700; color: black; display: inline;">21.&nbsp;</h5>
                                        <asp:CheckBox ID="ChkEcoMCCfan" Text="Filter" CssClass="myClass" runat="server" />
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" style="display: inline;">
                                                ...
                                                <asp:DropDownList ID="ddlthickmodularecord" runat="server">
                                                    <asp:ListItem>Select Thickness</asp:ListItem>
                                                    <asp:ListItem>1.2mm</asp:ListItem>
                                                    <asp:ListItem>1.5mm</asp:ListItem>
                                                    <asp:ListItem>2.00mm</asp:ListItem>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" style="display: inline;">
                                                ...
                                                <asp:TextBox ID="txtlockQty" runat="server" Height="23px" Placeholder="Qty"></asp:TextBox>
                                            </div>
                                        </div>
                                        <%--12--%>
                                        <br />
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" style="display: inline;">
                                                <h5 style="font-size: 14px; font-weight: 700; color: black; display: inline;">15.&nbsp;</h5>
                                                <asp:CheckBox ID="ChkWMM23TransparentDoorModular" Text="Transparent Door" CssClass="myClass" runat="server" />
                                                <asp:DropDownList ID="ddlWMM23TransparentDoorcat1modular" runat="server">
                                                    <asp:ListItem>Select</asp:ListItem>
                                                    <asp:ListItem>Glass</asp:ListItem>
                                                    <asp:ListItem>Acrylic</asp:ListItem>
                                                    <asp:ListItem>Polycarbonate</asp:ListItem>
                                                </asp:DropDownList>
                                                <asp:DropDownList ID="ddlWMM23TransparentDoorcat2Modualr" runat="server">
                                                    <asp:ListItem>Select Thickness</asp:ListItem>
                                                    <asp:ListItem>3.00mm</asp:ListItem>
                                                    <asp:ListItem>4.00mm</asp:ListItem>
                                                    <asp:ListItem>5.00mm</asp:ListItem>
                                                </asp:DropDownList>
                                                <asp:DropDownList ID="ddlWMM23TransparentDoorcat3modular" runat="server">
                                                    <asp:ListItem>Select</asp:ListItem>
                                                    <asp:ListItem>With bidding</asp:ListItem>
                                                    <asp:ListItem>biddingless technique</asp:ListItem>
                                                </asp:DropDownList>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" style="display: inline;">
                                                ...
                                                <asp:CheckBox ID="ChkModularfan" Text="Filter" CssClass="myClass" runat="server" />
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" style="display: inline;">
                                                ...
                                                <asp:DropDownList ID="ddlthicknessecoframe" runat="server">
                                                    <asp:ListItem>Select Thickness</asp:ListItem>
                                                    <asp:ListItem>1.5mm</asp:ListItem>
                                                    <asp:ListItem>2.00mm</asp:ListItem>
                                                </asp:DropDownList>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" style="display: inline;">
                                                ...
                                                <asp:TextBox ID="txtecoframelockqty" runat="server" Height="23px" Placeholder="Qty"></asp:TextBox>
                                            </div>
                                        </div>
                                        <%--11--%>
                                        <br />
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" style="display: inline;">
                                                ...
                                                <asp:DropDownList ID="ddlecoframebasethickness" runat="server">
                                                    <asp:ListItem>Select Thickness</asp:ListItem>
                                                    <asp:ListItem>2.00mm</asp:ListItem>
                                                    <asp:ListItem>3.00mm</asp:ListItem>
                                                    <asp:ListItem>5.00mm</asp:ListItem>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" style="display: inline;">
                                                <h5 style="font-size: 14px; font-weight: 700; color: black; display: inline;">19.&nbsp;</h5>
                                                <asp:CheckBox ID="checkfibration" Text="Anti-Fibration pad" CssClass="myClass" runat="server" />

                                                <asp:DropDownList ID="ddlfibration" runat="server">
                                                    <asp:ListItem>Select Thickness</asp:ListItem>
                                                    <asp:ListItem>12.00mm</asp:ListItem>
                                                    <asp:ListItem>15.00mm</asp:ListItem>
                                                    <asp:ListItem>25.00mm</asp:ListItem>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" style="display: inline;">
                                                ...
                                                <asp:CheckBox ID="ChkEcoFramefan" Text="Filter" CssClass="myClass" runat="server" />
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12" style="display: inline;">
                                                            ...
                                                            <asp:TextBox ID="txtqtyenclouser" runat="server" Height="23px" Placeholder="Qty"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <%--24--%>
                                                    <br />
