<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="ReceiptList.aspx.cs" Inherits="Admin_ReceiptList" %>
                ...
                <div class="col-md-5">
                    <div class="page-header-breadcrumb">
                        <div style="float: right; margin: 3px; margin-bottom: 5px;">
                            <span id="btnAddReceipt" runat="server"><a href="Receipt.aspx" style="font-size: 16px; border: 1px dashed gray; padding: 4px;">&nbsp;Add Receipt</a>&nbsp;&nbsp;
                            </span>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="col-md-12" style="padding: 0px; margin-top: 10px;">
                                        <div id="DivRoot" align="left">
                                            ...
                                            <div style="overflow: scroll;" class="dt-responsive table-responsive" onscroll="OnScrollDiv(this)" id="DivMainContent">
                                                <asp:GridView ID="GvRecipt" runat="server"
                                                    CssClass="table table-striped table-bordered nowrap" AutoGenerateColumns="false"
                                                    AllowPaging="false" ShowHeader="true" PageSize="50" DataKeyNames="Id" OnRowCommand="GvRecipt_RowCommand" OnRowDataBound="GvRecipt_RowDataBound">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="No" HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblid" runat="server" Text='<%# Eval("Id") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="From- To" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Account Name" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                            <ItemTemplate>
                                                      ...
                                                      <%--  <asp:TemplateField HeaderText="Bank Name" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                        ...
                                                        <asp:TemplateField HeaderText="Against" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblAgainst" runat="server" Text='<%# Eval("Against") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Transaction By" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:LinkButton runat="server" id="btnpdf" CommandName="DownloadPDF" CommandArgument='<%# Eval("Id") %>' ToolTip="Download"><i class="fa fa-file-pdf-o" style="font-size:24px;color:red;"></i></asp:LinkButton>
