<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Welding_OldDB.aspx.cs" Inherits="Admin_Welding_OldDB" %>
                                            ...
                                            <asp:GridView ID="dgvWelding" runat="server" CssClass="table table-striped table-bordered nowrap"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Out Qty" ItemStyle-Width="150" ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:TextBox runat="server" ID="txtOutwardQty" Width="100%" onkeypress="return ValidNumeric()" onblur="Keydown(this);" AutoPostBack="false" CssClass="form-control" Text='<%# Eval("InwardQty") %>'></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
