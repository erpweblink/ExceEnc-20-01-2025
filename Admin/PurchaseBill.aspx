<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="PurchaseBill.aspx.cs" Inherits="Admin_PurchaseBill" %>
                        ...
                        <div class="col-md-5">
                            <div class="page-header-breadcrumb">
                                <div style="float: right; margin: 3px; margin-bottom: 5px;">
                                    <span><a href="PurchaseBillList.aspx" style="font-size: 16px; border: 1px dashed gray; padding: 4px;">&nbsp;Purchase Bill List</a>&nbsp;&nbsp;
                                    </span>
                                </div>
                            </div>
                        </div>
                                                        ...
                                                        <div class="table-responsive" runat="server" id="DivVerbal" visible="false">
                                                            <table class="table" border="1" style="width: 100%; border: 1px solid #0c7d38;">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtVQty" Width="50px" runat="server" AutoPostBack="true" OnTextChanged="txtVQty_TextChanged"></asp:TextBox>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtVCGSTPer" Width="50px" runat="server" AutoPostBack="true" OnTextChanged="txtVCGSTPer_TextChanged" placeholder="%"></asp:TextBox>
                                                                        <asp:TextBox ID="txtVCGSTAmt" Width="100px" runat="server" ReadOnly="true" placeholder="CGSTAmt"></asp:TextBox>
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtVSGSTPer" Width="50px" runat="server" AutoPostBack="true" OnTextChanged="txtVSGSTPer_TextChanged" placeholder="%"></asp:TextBox>
                                                                        <asp:TextBox ID="txtVSGSTAmt" Width="100px" runat="server" ReadOnly="true" placeholder="SGSTAmt"></asp:TextBox>
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtVIGSTPer" Width="50px" runat="server" AutoPostBack="true" OnTextChanged="txtVIGSTPer_TextChanged" placeholder="%"></asp:TextBox>
