<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="PCreditDebitNote.aspx.cs" Inherits="Admin_PCreditDebitNote" %>
                        ...
                        <div class="col-md-5">
                            <div class="page-header-breadcrumb">
                                <div style="float: right; margin: 3px; margin-bottom: 5px;">
                                    <span><a href="PCreditDebitNoteList.aspx" style="font-size: 16px; border: 1px dashed gray; padding: 4px;">&nbsp;Credit/Debit Note List</a>&nbsp;&nbsp;
                                    </span>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <asp:DropDownList ID="ddlNoteType" runat="server" class="form-control">
