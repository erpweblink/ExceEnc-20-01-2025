<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="CompletedOADepartmentWiseRpt.aspx.cs" Inherits="Admin_CompletedOADepartmentWiseRpt" %>
                            ...
                            <div class="row" style="padding: 10px;">
                                <div class="col-md-10">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <asp:DropDownList ID="ddlDepartment" OnTextChanged="ddlDepartment_TextChanged" CssClass="form-control" runat="server" Width="100%" AutoPostBack="true">
                                        ...
                                        <div class="col-md-2 spancls" runat="server" id="divlabl" visible="false">Date:</div>
                                        <div class="col-md-3">
                                            <asp:TextBox ID="txtDate" AutoComplete="off" CssClass="form-control myDate" OnTextChanged="txtDate_TextChanged" Visible="false" AutoPostBack="true" runat="server" placeholder="Select Date"></asp:TextBox>
                                        </div>
                                        <div class="col-md-1">
                                ...
                                <div class="col-md-12" style="padding: 30px;">
                                    <div>
                                        <div class="card" runat="server" id="divDrawing" visible="false">
                                            <div class="card-header bg-primary text-uppercase text-white">
                                                <h5>
                                                    <asp:Label runat="server" ID="lblDeptNameHeader" ForeColor="#ffffff"></asp:Label></h5>
                                            </div>
                                            <br />
