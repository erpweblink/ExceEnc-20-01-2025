<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="EInv_CrDbNote.aspx.cs" Inherits="Admin_TaxInvoiceList" %>
                ...
                <div class="col-md-5">
                    <div class="page-header-breadcrumb">
                        <div style="float: right; margin: 3px; margin-bottom: 5px;">
                            <span id="btnAddEwayBill" runat="server"><a href="EWayBillList_CrDbNote.aspx" style="font-size: 16px; border: 1px dashed gray; padding: 4px;">&nbsp;Add E-Way Bill</a>&nbsp;&nbsp;
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="container py-3">
                <div class="card">
                    <div class="card-header bg-primary text-uppercase text-white">
                        <div class="row">
                            <div class="col-md-12">
                                <h5>E-Invoice List (From Credit/Debit Note)</h5>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                            ...
                                            <div style="overflow: scroll;" class="dt-responsive table-responsive" onscroll="OnScrollDiv(this)" id="DivMainContent">
                                                <asp:GridView ID="GvInvoiceList" runat="server"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Cr./Db. Note No" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblInvoiceNo" runat="server" Text='<%# Eval("DocNo") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Note Type" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Doc. Date" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblInvoicedate" runat="server" Text='<%# Eval("DocDate","{0:d}") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                        <asp:TemplateField HeaderText="Referance No" Visible="false" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
