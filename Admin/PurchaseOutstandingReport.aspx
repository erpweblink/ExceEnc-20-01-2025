<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="PurchaseOutstandingReport.aspx.cs" Inherits="Admin_PurchaseOutstandingReport" %>
            ...
            <div class="container py-3">
                ...
                <div class="card">
                    <div class="card-header bg-primary text-uppercase text-white">
                        <div class="row">
                            <div class="col-md-4">
                                <h5> Purchase Outstanding Report</h5>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-xl-3 col-md-3">
                                            <asp:Label ID="lblname" runat="server" Font-Bold="true">Party Name</asp:Label>
                                        ...
                                        <div class="col-xl-3 col-md-3">
                                            <asp:Label ID="Label1" runat="server" Font-Bold="true">From Date</asp:Label>
                                        ...
                                        <div class="col-xl-3 col-md-3">
                                            <asp:Label ID="Label2" runat="server" Font-Bold="true">To Date</asp:Label>
                                        ...
                                        <div class="col-xl-3 col-md-3">
                                            <asp:TextBox ID="ddltype" runat="server" CssClass="form-control" Visible="false" Width="100%" Text="Purchase" ReadOnly="true"></asp:TextBox>
                                        </div>
                                    </div>
                                    <br />
