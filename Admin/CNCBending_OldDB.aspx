<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="CNCBending_OldDB.aspx.cs" Inherits="Admin_CNCBending_OldDB" %>
                                        ...
                                        <div style="overflow: scroll;" class="dt-responsive table-responsive" onscroll="OnScrollDiv(this)" id="DivMainContent">
                                            <asp:GridView ID="dgvCNCBending" runat="server" CssClass="table table-striped table-bordered nowrap"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Return Qty" Visible="false" ItemStyle-Width="60" ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
