...
public partial class Admin_AddCompany : System.Web.UI.Page
{
    ...
    protected void Pdf()
    {
        ...
        iTextSharp.text.pdf.PdfWriter writer = iTextSharp.text.pdf.PdfWriter.GetInstance(doc, new FileStream(Server.MapPath("~/files/E_Inv_FromCRDBNote/") + Docname, FileMode.Create));
        ...
        ifrRight6.Attributes["src"] = @"../files/E_Inv_FromCRDBNote/" + Docname;
    ...
    protected void EwayPdf()
    {
        ...
        doc.Close();
        Iframe1.Attributes["src"] = @"../files/EwayBill_FromCRDBNote/" + Docname;
    }
