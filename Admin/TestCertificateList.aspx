<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="TestCertificateList.aspx.cs" Inherits="Admin_TestCertificateList" %>
                ...
                <div class="col-md-5">
                    <div class="page-header-breadcrumb">
                        <div style="float: right; margin: 3px; margin-bottom: 5px;">
                            <span id="btnAddtestCert" runat="server"><a href="TestCertificate.aspx" style="font-size: 16px; border: 1px dashed gray; padding: 4px;">&nbsp;Add Test Certificate</a>&nbsp;&nbsp;
                            </span>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="col-md-12" style="padding: 0px; margin-top: 10px;">
                                        <div id="DivRoot" align="left">
                                            ...
                                            <div style="overflow: scroll;" class="dt-responsive table-responsive" onscroll="OnScrollDiv(this)" id="DivMainContent">
                                                <asp:GridView ID="GvTestCertificatelist" runat="server"
                                                    CssClass="table table-striped table-bordered nowrap" AutoGenerateColumns="false"
                                                    AllowPaging="false" ShowHeader="true" PageSize="50" OnRowCommand="GvTestCertificatelist_RowCommand" DataKeyNames="Id">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Kind Att." ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="lnkPDF" runat="server" CommandName="ViewPDF" CommandArgument='<%# Eval("Id") %>' ToolTip="View PDF"><i class="fa fa-file-pdf-o" style="font-size:24px;color:red;"></i></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
