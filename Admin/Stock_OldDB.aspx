<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Stock_OldDB.aspx.cs" Inherits="Admin_Stock_OldDB" EnableEventValidation="false" %>
                        ...
                        <div class="card">
                            ...
                            <div class="row" style="padding: 10px;">
                                ...
                                <div class="col-md-2" id="btnshowhide">
                                    <asp:LinkButton ID="btnGetSelected" runat="server" CssClass="btn btn-small btn-primary" OnClick="GetSelectedRecords" OnClientClick="Confirm()"><i class="fa fa-truck"></i>&nbsp;Dispatch</asp:LinkButton>
                                    <%--fa fa-send-o--%>
                                </div>
                                <div class="col-md-1">
                                </div>
                                        ...
                                        <div style="overflow: scroll;" class="dt-responsive table-responsive" onscroll="OnScrollDiv(this)" id="DivMainContent">
                                            <asp:GridView ID="dgvStock" runat="server" CssClass="table table-striped table-bordered nowrap"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Return Qty"  ItemStyle-Width="100"  ItemStyle-HorizontalAlign="Center" Visible="false">
                                                        <ItemTemplate>
