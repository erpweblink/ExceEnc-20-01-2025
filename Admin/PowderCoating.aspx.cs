...
public partial class Admin_PowderCoating : System.Web.UI.Page
{
    ...
    {
        SqlDataAdapter ad = new SqlDataAdapter("select PowdercoatId, OANumber as OANumber from tblPowderCoating where IsApprove=1 and IsComplete is null order by PowdercoatId desc", con);
        DataTable dt = new DataTable();
        ad.Fill(dt);
        if (dt.Rows.Count > 0)
        {
                    ...
                    if (row.RowType == DataControlRowType.DataRow)
                    {
                        ...
                        else
                        {
                            if (chkRow.Checked)
                            {
                                ...
                                {
                                    ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Alert!!!!!- Outward Quantity Is Greater Than Inward Quantity...!');window.location.href='PowderCoating.aspx';", true);
                                    return;
                                }
                            }
                        }
                ...
                using (con)
                {
                    using (SqlCommand cmd = con.CreateCommand())
                    {
                        ...
                        foreach (DataRow row in dt.Rows)
                        {
                            ...
                            SqlCommand cmdexsist = new SqlCommand("select OANumber,InwardQty,OutwardQty,SubOA from tblFinalAssembly WHERE SubOA='" + row["SubOA"].ToString() + "'", con);
                            ...
                            SqlCommand cmd2 = new SqlCommand("select OutwardQty from tblPowderCoating WHERE SubOA='" + row["SubOA"].ToString() + "'", con);
                            string Outward2Qty = "";
                            ...
                            if (OanumberExsists == "")
                            {
                                ...
                                using (SqlBulkCopy sqlBulkCopy = new SqlBulkCopy(con))
                                {
                                    ...
                                    sqlBulkCopy.DestinationTableName = "dbo.tblFinalAssembly";
                            ...
                            else
                            {
                                ...
                                SqlCommand cmdupdate = new SqlCommand("UPDATE [dbo].[tblFinalAssembly] SET [InwardQty] = '" + totOutwardqnt.ToString() + "',[IsComplete]=NULL,[InwardDtTime]='" + row["outwarddatetime"].ToString() + "' WHERE SubOA='" + row["SubOA"].ToString() + "'", con);
                            ...
                            if (row["inwardqty"].ToString() == row["outwardqty"].ToString())
                            {
                                ...
                                //SqlCommand cmdupdate = new SqlCommand("UPDATE [dbo].[tblPowderCoating] SET [OutwardQty] = '" + row["totalinward"].ToString() + "',[InwardQty]='0',[IsComplete]=1,OutwardDtTime= '" + OutwardDtTime.ToString() + "',UpdatedDate='" + OutwardDtTime + "' WHERE SubOA='" + row["SubOA"].ToString() + "'", con);
                                SqlCommand cmdupdate = new SqlCommand("UPDATE [dbo].[tblPowderCoating] SET [OutwardQty] = '" + row["inwardqty"].ToString() + "',[InwardQty]='0',[IsComplete]=1,OutwardDtTime= '" + OutwardDtTime.ToString() + "',UpdatedDate='" + OutwardDtTime + "' WHERE SubOA='" + row["SubOA"].ToString() + "'", con);
                                cmdupdate.ExecuteNonQuery();
                            }
                            //END
                            else
                            {
                                ...
                                SqlCommand cmdupdate = new SqlCommand("UPDATE [dbo].[tblPowderCoating] SET [InwardQty] = '" + inwardqy.ToString() + "', [OutwardQty] = '" + totoutward.ToString() + "',OutwardDtTime= '" + OutwardDtTime.ToString() + "',UpdatedDate='" + OutwardDtTime + "' WHERE SubOA='" + row["SubOA"].ToString() + "'", con);
                                cmdupdate.ExecuteNonQuery();
                        ...
                        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Successfully- Approved and send to Final Assembly Department...!');window.location.href='PowderCoating.aspx';", true);
    ...
    protected void lnkbtnReturn_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                //Get Exsiting Record
                SqlCommand cmdselect = new SqlCommand("select InwardQty from [tblWelding] WHERE SubOA='" + hdnSubOANo.Value + "'", con);
                //Object Inwardqty = cmdselect.ExecuteScalar();
                int Inwardqty = Convert.ToInt32(cmdselect.ExecuteScalar() ?? 0);

                SqlCommand cmdselectt = new SqlCommand("select OutwardQty from [tblWelding] WHERE SubOA='" + hdnSubOANo.Value + "'", con);
                //Object Inwardqty = cmdselect.ExecuteScalar();
                ...
                if (Convert.ToInt32(txtReturnInward.Text) == Convert.ToInt32(hdnInwardQty.Value))
                {
                    ...
                    SqlCommand cmdupdate1 = new SqlCommand("UPDATE [dbo].[tblWelding] SET [InwardQty] = '" + TotalReturnInward + "',[IsComplete] = NULL, [OutwardQty] = '0' WHERE SubOA='" + hdnSubOANo.Value + "'", con);
                ...
                else
                {
                    ...
                    SqlCommand cmdupdate = new SqlCommand("UPDATE [dbo].[tblPowderCoating] SET [InwardQty] = '" + TotalReturn_Outward + "',[OutwardQty] = '" + TotalReturn_Outward + "' WHERE SubOA='" + hdnSubOANo.Value + "'", con);
                    cmdupdate.ExecuteNonQuery();
                ...
                con.Close();
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Quantity has been Return Successfully..!');window.location.href='PowderCoating.aspx';", true);
            }
        }
        catch (Exception)
        {
    ...
    protected void dgvPowderCoating_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (Dt.Rows.Count > 0)
            {
                ...
                SqlDataAdapter Sdd = new SqlDataAdapter("Select * FROM [ExcelEncLive].[tblUserRoleAuthorization] where UserID = '" + idd + "' AND PageName = 'PowderCoating.aspx' AND PagesView = '1'", con);
                Sdd.Fill(Dtt);
                if (Dtt.Rows.Count > 0)
                {
            ...
            gvDetails.DataSource = GetData(string.Format("select * from  [ExcelEncLive].[vw_PowderCoating] where SubOA='{0}'", Id));
            gvDetails.DataBind();
        }
    }
...
left join orderaccept AS O ON LP.oanumber=o.oano
    ...
    {
        SqlCommand cmdselect1 = new SqlCommand("select InwardQty from tblPowderCoating WHERE SubOA='" + hdnSubOANo.Value + "'", con);
        Object LCInwardqty = cmdselect1.ExecuteScalar();

        SqlCommand cmdselect2 = new SqlCommand("select InwardQty from tblFinalAssembly WHERE SubOA='" + hdnSubOANo.Value + "'", con);
        ...
        SqlCommand cmdupdate = new SqlCommand("UPDATE [dbo].[tblPowderCoating] SET [OutwardQty] = '" + CNCInwardQty + "' WHERE SubOA='" + hdnSubOANo.Value + "'", con);
        cmdupdate.ExecuteNonQuery();
        //END
        ...
        SqlCommand cmdupdatee = new SqlCommand("UPDATE [dbo].[tblWelding] SET [OutwardQty] = '" + LCInwardqty + "' WHERE SubOA='" + hdnSubOANo.Value + "'", con);
    ...
    //protected void GetSelectedRecords(object sender, EventArgs e)
    //{
    //    string confirmValue = "Yes"; // Ideally, get this value dynamically
    //    if (confirmValue == "Yes")
    //    {
    //        DataTable dt = new DataTable();
    //        bool flag = false;
    ...
    //                    string InwardQty = ((TextBox)row.Cells[1].FindControl("txtInwardQty")).Text;
    //                    string OutwardDtTime = DateTime.Now.ToString("dd-MM-yyyy hh:mm tt");
    //                    string OutwardQty = ((TextBox)row.Cells[1].FindControl("txtOutwardQty")).Text.Split(',')[1].ToString();
    ...
    //        if (dt.Rows.Count == 0)
    //        {
    //            ScriptManager.RegisterStartupScript(this, this.GetType(), "Alert", "alert('Please select at least one row');", true);
    //            return;
    //        }
    ...
    //            foreach (DataRow row in dt.Rows)
    //            {
    //                // Check if the SubOA already exists in tblFinalAssembly
    //                SqlCommand cmdExsist = new SqlCommand("SELECT OANumber, InwardQty, OutwardQty, SubOA FROM tblFinalAssembly WHERE SubOA = @SubOA", con);
    //                cmdExsist.Parameters.AddWithValue("@SubOA", row["SubOA"]);
    ...
    //                if (!isExist)
    //                {
    //                    // Insert new record in tblFinalAssembly
    //                    SqlCommand cmdInsert = new SqlCommand("INSERT INTO tblFinalAssembly (OANumber, SubOA, CustomerName, Size, TotalQty, InwardDtTime, InwardQty, DeliveryDate, IsApprove) VALUES (@OANumber, @SubOA, @CustomerName, @Size, @TotalQty, @InwardDtTime, @InwardQty, @DeliveryDate, @IsApprove)", con);
    //                    cmdInsert.Parameters.AddWithValue("@OANumber", row["OAnumber"]);
    //                    cmdInsert.Parameters.AddWithValue("@SubOA", row["SubOA"]);
    ...
    //                else
    //                {
    //                    // Update existing record in tblFinalAssembly
    //                    int inwardQty = Convert.ToInt32(row["inwardqty"]);
    //                    int outwardQty = Convert.ToInt32(row["outwardqty"]);
    //                    int totOutwardQty = inwardQty + outwardQty;
    //                    SqlCommand cmdUpdate = new SqlCommand("UPDATE tblFinalAssembly SET InwardQty = @InwardQty, IsComplete = NULL, InwardDtTime = @InwardDtTime WHERE SubOA = @SubOA", con);
    //                    cmdUpdate.Parameters.AddWithValue("@InwardQty", totOutwardQty);
    //                    cmdUpdate.Parameters.AddWithValue("@InwardDtTime", row["outwarddatetime"]);
    //                    cmdUpdate.Parameters.AddWithValue("@SubOA", row["SubOA"]);
    //                    cmdUpdate.ExecuteNonQuery();
    //                }

    //                // Update tblPowderCoating
    //                string OutwardDtTime = DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss");
    //                int inwardQtyPowder = Convert.ToInt32(row["inwardqty"]);
    //                int outwardQtyPowder = Convert.ToInt32(row["outwardqty"]);
    //                int totalOutward = inwardQtyPowder + outwardQtyPowder;

    //                SqlCommand cmdPowderUpdate = new SqlCommand("UPDATE tblPowderCoating SET InwardQty = @InwardQty, OutwardQty = @OutwardQty, OutwardDtTime = @OutwardDtTime, UpdatedDate = @UpdatedDate WHERE SubOA = @SubOA", con);
    //                cmdPowderUpdate.Parameters.AddWithValue("@InwardQty", inwardQtyPowder);
    //                cmdPowderUpdate.Parameters.AddWithValue("@OutwardQty", totalOutward);
    //                cmdPowderUpdate.Parameters.AddWithValue("@OutwardDtTime", OutwardDtTime);
    //                cmdPowderUpdate.Parameters.AddWithValue("@UpdatedDate", OutwardDtTime);
    //                cmdPowderUpdate.Parameters.AddWithValue("@SubOA", row["SubOA"]);

    //                cmdPowderUpdate.ExecuteNonQuery();
    //            }

    //            con.Close();
    //        }

    //        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Successfully approved and sent to Final Assembly Department!'); window.location.href='PowderCoating.aspx';", true);
    //    }
    //    else
    //    {
    //        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Cancelled Successfully..!')", true);
    ...
    public void Getpreviousqty()
    {
        ...
        object result = cmdselect6.ExecuteScalar();
        ...
        SqlCommand cmdupdate = new SqlCommand("UPDATE [dbo].[tblPowderCoating] SET [OutwardQty] = @OutwardQty WHERE SubOA='" + hdnSubOANo.Value + "'", con);
        ...
        SqlCommand cmdupdatee = new SqlCommand("UPDATE [dbo].[tblWelding] SET [OutwardQty] = '" + CNCInwardQty + "' WHERE SubOA='" + hdnSubOANo.Value + "'", con);
        cmdupdatee.ExecuteNonQuery();
        //END
    ...
    public void GetRecords(string SubOa)
    {
        ...
        try
        {
            ...
            cmd.Parameters.AddWithValue("@Currentstages", "tblPowderCoating");
            cmd.Parameters.AddWithValue("@prevousStage", "tblWelding");
    ...
    public void CheckInwardqtystages(String SubOA)
    {
        ...
        SqlCommand cmdselect5 = new SqlCommand("select OutwardQty from tblFinalAssembly WHERE SubOA=@SubOA", con);
        ...
        // Now update the table with the determined CNCInwardQty
        SqlCommand cmdupdate = new SqlCommand("UPDATE [dbo].[tblFinalAssembly] SET [OutwardQty] = @OutwardQty WHERE SubOA=@SubOA", con);
        cmdupdate.Parameters.AddWithValue("@OutwardQty", CNCInwardQty);
    ...
    public void Checkoutwardqtnyofcuurentstage(String SubOA)
    {
        ...
        if (result != DBNull.Value && result != null && result.ToString() != "0")
        {
            ...
            SqlCommand cmdupdate1 = new SqlCommand("UPDATE [dbo].[tblPowderCoating] SET [OutwardQty] = @OutwardQty WHERE SubOA=@SubOA", con);
