<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Welding.aspx.cs" Inherits="Admin_Welding" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    ...
                    <div class="container-fluid">
                        <div class="card">
                            ...
                            <div class="row" style="padding: 10px;">
                                <div class="col-md-4">
                                    <asp:TextBox ID="TextxtCustomerNametNew" runat="server" CssClass="form-control" placeholder="Customer Name" Width="100%" OnTextChanged="TextxtCustomerNametNew_TextChanged" AutoPostBack="true"></asp:TextBox>
                                    <asp:AutoCompleteExtender ID="AutoCompleteExtender3" runat="server" CompletionListCssClass="completionList"
                                        ...
                                        TargetControlID="TextxtCustomerNametNew">
        ...
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="dgvWelding" />
