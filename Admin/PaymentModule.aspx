<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="PaymentModule.aspx.cs" Inherits="Admin_PaymentModule" %>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-1 col-md-1">
                                                    <asp:Button ID="btnSubmit" CssClass="btn btn-success" runat="server" Text="Submit" Style="padding: 8px;" OnClick="btnSubmit_Click" />
                                                </div>
                                                <div class="col-xl-1 col-md-1">
                                                    <asp:Label runat="server" Text="Total"></asp:Label>
                                                </div>
                                                <div class="col-xl-2 col-md-2">
                                                    <asp:TextBox runat="server" CssClass="form-control" ID="txtGrandTotal" ReadOnly="true"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Total Amt" ItemStyle-HorizontalAlign="Center">
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <asp:Label runat="server" ID="lblgridmsg" ForeColor="Red"></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                 <asp:TemplateField HeaderText="Recvd Value" ItemStyle-HorizontalAlign="Center">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox runat="server" ID="txtRecvdValue" Width="100" Enabled="false" Text="0"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Paid Value" ItemStyle-HorizontalAlign="Center">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox runat="server" ID="txtPaidValue" Width="100" Enabled="false" Text="0" AutoPostBack="true" OnTextChanged="txtPaidValue_TextChanged"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

                                                                <asp:TemplateField HeaderText="Due Date" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblPaymentDueDate" runat="server" Text='<%# Eval("PaymentDueDate").ToString().TrimEnd("0:0".ToCharArray()) %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

                                                                <asp:TemplateField HeaderText="Created By" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblCreatedBy" runat="server" Text='<%# Eval("CreatedBy") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

                                                                <asp:TemplateField HeaderText="Ref Doc" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                                    <ItemTemplate>
