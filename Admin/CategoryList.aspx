<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="CategoryList.aspx.cs" Inherits="Admin_CategoryList" %>
                ...
                <div class="col-md-5">
                    <div class="page-header-breadcrumb">
                        <div style="float: right; margin: 3px; margin-bottom: 5px;">
                            <span id="btnAddCategory" runat="server"><a href="CategoryMaster.aspx" style="font-size: 16px; border: 1px dashed gray; padding: 4px;">&nbsp;Add Category</a>&nbsp;&nbsp;
                            </span>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-3 col-md-3">
                                            <asp:TextBox ID="txtcnamefilter" runat="server" CssClass="form-control" placeholder="Category name" Width="100%" OnTextChanged="txtcnamefilter_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        ...
                                        <div id="DivRoot" align="left">
                                            ...
                                            <div style="overflow: scroll;" class="dt-responsive table-responsive" onscroll="OnScrollDiv(this)" id="DivMainContent">
                                                <asp:GridView ID="GvCategory" runat="server"
                                                    ...
                                                    DataKeyNames="id" OnRowCommand="GvCategory_RowCommand" AllowPaging="false" ShowHeader="true" PageSize="50">
                                                    <Columns>
