<%@ Page Title="" Debug="true" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="PartyLedgerReport.aspx.cs" Inherits="Admin_PartyLedgerReport" %>
                        ...
                        <div class="col-xl-12 col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="row" style="margin-left: -12px;"><asp:HiddenField ID="hiddenopening" runat="server" /><asp:HiddenField ID="HiddenClosing" runat="server" />
