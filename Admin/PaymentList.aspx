<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="PaymentList.aspx.cs" Inherits="Admin_PaymentList" %>
                ...
                <div class="col-md-5">
                    <div class="page-header-breadcrumb">
                        <div style="float: right; margin: 3px; margin-bottom: 5px;">
                            <span id="btnAddPayment" runat="server"><a href="Payment.aspx" style="font-size: 16px; border: 1px dashed gray; padding: 4px;">&nbsp;Add Payment</a>&nbsp;&nbsp;
                            </span>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div id="DivRoot" align="left">
                                            ...
                                            <div style="overflow: scroll;" class="dt-responsive table-responsive" onscroll="OnScrollDiv(this)" id="DivMainContent">
                                                <asp:GridView ID="GvPayment" runat="server"
                                                    ...
                                                    AllowPaging="false" ShowHeader="true" DataKeyNames="Id" PageSize="50" OnRowCommand="GvPayment_RowCommand" OnRowDataBound="GvPayment_RowDataBound">
                                                    <Columns>
