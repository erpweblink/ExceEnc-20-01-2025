<%@ Page Title="" Debug="true" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Receipt.aspx.cs" Inherits="Admin_Receipt" %>
                                                ...
                                                <div class="table-responsive">
                                                    <asp:GridView ID="Gvreceipt" runat="server"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Recvd" ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="lblratee" runat="server" Enabled="true" CssClass="gvtxtwidth" Text="0"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
