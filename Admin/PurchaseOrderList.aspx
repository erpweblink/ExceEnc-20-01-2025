<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="PurchaseOrderList.aspx.cs" Inherits="Admin_PurchaseOrderList" %>
                ...
                <div class="col-md-5">
                    <div class="page-header-breadcrumb">
                        <div style="float: right; margin: 3px; margin-bottom: 5px;">
                            <span id="btnAddPO" runat="server"><a href="PurchaseOrder.aspx" style="font-size: 16px; border: 1px dashed gray; padding: 4px;">&nbsp;Add Purchase Order</a>&nbsp;&nbsp;
                            </span>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="col-md-12" style="padding: 0px; margin-top: 10px;">
                                        <div id="DivRoot" align="left">
                                            ...
                                            <div style="overflow: scroll;" class="dt-responsive table-responsive" onscroll="OnScrollDiv(this)" id="DivMainContent">
                                                <asp:GridView ID="GvPurchaseOrder" runat="server"
                                                    CssClass="table table-striped table-bordered nowrap" AutoGenerateColumns="false"
                                                    DataKeyNames="id" OnRowCommand="GvPurchaseOrder_RowCommand" AllowPaging="false" ShowHeader="true" PageSize="50" OnRowDataBound="GvPurchaseOrder_RowDataBound">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Refer Quotation" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
