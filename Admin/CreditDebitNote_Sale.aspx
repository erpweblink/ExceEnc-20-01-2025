<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="CreditDebitNote_Sale.aspx.cs" Inherits="Admin_CreditDebitNote" %>
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="page-header-breadcrumb">
                                <div style="float: right; margin: 3px; margin-bottom: 5px;">
                                    <span><a href="CreditDebitNoteSaleList.aspx" style="font-size: 16px; border: 1px dashed gray; padding: 4px;">&nbsp;Credit/Debit Note List</a>&nbsp;&nbsp;
                                    </span>
                                </div>
                            </div>
                        </div>
