...
public partial class Admin_TaxInvoicePDF : System.Web.UI.Page
{
    ...
    protected void Pdf()
    {
        ...
        if (Dt.Rows.Count > 0)
        {
            ...
            GrandTOTALAmount = Convert.ToDouble(ValueOFSupply) + CGSTAmount + SGSTAmount + IGSTAmount + Convert.ToDouble(TCSAmt);
            ...
            if (Dt.Rows.Count > 0)
            {
                ...
                table.AddCell(new Phrase(TCSAmt, FontFactory.GetFont("Arial", 9)));
                table.AddCell(new Phrase("00.00", FontFactory.GetFont("Arial", 9)));
    ...
    protected void Pdf_CRDBNote()
    {
        ...
        if (Dt.Rows.Count > 0)
        {
            ...
            con.Open();
            SqlCommand cmdE_inv_Typeof_supply = new SqlCommand("select E_inv_Typeof_supply from company where cname='" + billingCustomer + "'", con);
