<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="ItemList.aspx.cs" Inherits="Admin_ItemList" %>
                ...
                <div class="col-md-5">
                    <div class="page-header-breadcrumb">
                        <div style="float: right; margin: 3px; margin-bottom: 5px;">
                            <span id="btnAddItem" runat="server"><a href="ItemMaster.aspx" style="font-size: 16px; border: 1px dashed gray; padding: 4px;">&nbsp;Add Item</a>&nbsp;&nbsp;
                            </span>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div id="DivRoot" align="left">
                                            ...
                                            <div style="overflow: scroll;" class="dt-responsive table-responsive" onscroll="OnScrollDiv(this)" id="DivMainContent">
                                                <asp:GridView ID="GvItem" runat="server"
                                                    ...
                                                    DataKeyNames="id" OnRowCommand="GvItem_RowCommand" AllowPaging="false" ShowHeader="true" PageSize="50">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Item Name">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="lnkItemname" runat="server" CssClass="linkbtn" CommandName="Itemname" Text='<%# Eval("ItemName") %>' CommandArgument='<%# Eval("id") %>' ToolTip="View Details"></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="HSN Code" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblHSNCode" runat="server" Text='<%# Eval("HSN") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                        <asp:TemplateField HeaderText="Opening Stock" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
