<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="OutstandingReport_PaymentTerm.aspx.cs" Inherits="Admin_OutstandingReport" %>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row" style="margin-left: -12px;">
                                        <div class="col-xl-2 col-md-2 spancls">Payment Terms<i class="reqcls">&nbsp;</i> :</div>
                                        <%--<div class="col-xl-2 col-md-2 spancls" style="margin-left: 177px;">Payment Terms<i class="reqcls">&nbsp;</i> :</div>--%>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-3 col-md-3">
                                            <asp:DropDownList ID="ddlpaymentterm" CssClass="form-control" runat="server" Style="width: 100%;"></asp:DropDownList>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-md-3">
                                          ...
                                          <div class="col-xl-3 col-md-3"  runat="server" visible="false">
                                    ...
                                    <div class="row"  runat="server" visible="false">
                                        <div class="col-xl-3 col-md-3">
                                            <asp:Button ID="btnsearch1" runat="server" ValidationGroup="form1" CssClass="btn btn-primary" Text="Search" OnClick="btnsearch_Click" />
                                        </div>
                                    </div>
                                    <div class="row" id="btn" runat="server">
                                        <div class="col-xl-6 col-md-6">
                                            <asp:Button ID="btnexcel" runat="server" Visible="false" ValidationGroup="form1" CssClass="btn btn-primary" Text="Export Excel" OnClick="ExportExcel" />
                                     ...
                                     <div class="col-xl-3 col-md-3">
                                            <asp:TextBox ID="ddltype" runat="server" CssClass="form-control" Width="100%" Text="SALE" Visible="false" ReadOnly="true"></asp:TextBox>
                                        </div>
                                </div>
