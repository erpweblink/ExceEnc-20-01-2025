...
public partial class Admin_Addusers : System.Web.UI.Page
{
    ...
    private void Gvbind()
    {
        SqlDataAdapter ad = new SqlDataAdapter("SELECT [id],[empcode],Department,[name],[email],[emailpsw],[panelpsw],[mobile],[role],[status],[regdate] FROM [employees] where [isdeleted]=0 order by id desc", con);
