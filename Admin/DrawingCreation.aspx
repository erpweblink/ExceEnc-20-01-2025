<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="DrawingCreation.aspx.cs" Inherits="Admin_DrawingCreation" %>
                ...
                <div class="page-body">
                    <div class="container">
                        <div class="card">
                            ...
                            <div class="row" style="padding: 10px;">
                                <div class="col-md-8">
                                    <div class="row" runat="server" visible="false">
                                        ...
                                        <div class="col-md-3">
                                            <asp:TextBox runat="server" ID="txtcustomerName" CssClass="form-control"  AutoPostBack="true"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div id="DivRoot" style="margin-left:3%;">
                                    ...
                                    <div style="overflow: scroll;" class="dt-responsive table-responsive" onscroll="OnScrollDiv(this)" id="DivMainContent">
                                        <asp:GridView ID="dgvLaserprogram" runat="server" CssClass="table table-striped table-bordered nowrap"
                                            AutoGenerateColumns="false" DataKeyNames="VWID" OnRowCommand="dgvLaserprogram_RowCommand1" OnRowDataBound="dgvLaserprogram_RowDataBound">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Size" ItemStyle-Width="400" ItemStyle-HorizontalAlign="Center" Visible="true">
                                                    <ItemTemplate>
                                                        ...
                                                        <%--<asp:TextBox runat="server" ID="txtSize" TextMode="MultiLine" Rows="5" ReadOnly="true" Width="140" CssClass="form-control" Text='<%# Eval("Description") %>'></asp:TextBox>--%>
                                                ...
                                                <asp:TemplateField HeaderText="OutQty" ItemStyle-Width="150" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        <asp:TextBox runat="server" ID="txtOutwardQty" Width="60" OnTextChanged="txtOutwardQty_TextChanged1" AutoPostBack="true" CssClass="form-control" Text='<%# Eval("Qty") %>'></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Action" ItemStyle-Width="150" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        ...
                                                        <a href="<%#string.Format("../Reports/ReportPDF.aspx?Dept="+encrypt("Drawing")+"&OANumberWise={0}", encrypt(Eval("OAno").ToString())) %>" target="_blank" style="display: none">
                            ...
                            <br />
                            <!-- Returns -->
                            <div class="row" style="padding: 20px;" runat="server" id="divReturn" visible="false">
                                <div class="col-md-6">
                                    <div class="row" runat="server">
                                        <div class="col-md-3 spancls">Outward Qty:</div>
                                        <div class="col-md-3">
                                            <asp:TextBox runat="server" ID="txtReturnOutward" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                                        </div>
