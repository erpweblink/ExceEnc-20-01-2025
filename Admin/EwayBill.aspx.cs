...
public partial class Admin_AddCompany : System.Web.UI.Page
{
    ...
    //public string E_Way_Client_ID = "1ac62f83-68fe-4b0c-9755-ba74515cd657";
    //public string E_Way_Secret = "aa373932-cf89-452e-bb54-91753524744b";
    ...
    public string E_Way_Client_ID = "3a04fe7b-0648-49d0-a033-ed9c7eb549b8";
    public string E_Way_Secret = "af1366de-24d0-41b0-9cde-766805e30ec5";
    ...
    protected void txtTransporterID_TextChanged(object sender, EventArgs e)
    {
        try
        {
            GenrateGSTDtls("API_ExcelEnclosures", "ExcelEnc@Admin@123", "27ATFPS1959J1Z4", txtTransporterID.Text);
            con.Open();
            GetPDFDetails();
        }
        catch (Exception ex)
    ...
    protected void Pdf()
    {
        ...
        //05-06-2022
        string InvNo = Dt.Rows[0]["InvoiceNo"].ToString();
        string InvoiceNo = "";
        if (InvNo == "" || InvNo == null)
        {
        ...
        //string Path = ;
        string Docname = billingCustomer + "_" + stringInvoiceNo + "_E-Invoice.pdf";
        ...
        string imageURL = Server.MapPath("~/E_Inv_QrCOde/QR_Img.jpg");
        ...
        if (Dt.Rows.Count > 0)
        {
            ...
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "Excel Enclosures", 50, 780, 0);
            cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 18);
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "27ATFPS1959J1Z4", 50, 740, 0);


            cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "Gat No 1567 Shelar Wasti", 50, 725, 0);
            cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "Dehu Alandi Road, Chikhali 411062", 50, 715, 0);
            cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
            ...
            string imageURLL = Server.MapPath("~/E_Inv_QrCOde/Barcode_Img.png");
    ...
    //        SqlDataAdapter sadCompany = new SqlDataAdapter("select * from [tblTaxInvoiceHdr] where Id='" + lblHiddenid.Text + "'", con);
    ...
    //        DataTable dt = new DataTable();
    //        SqlCommand cmdFright = new SqlCommand("select Basic from [tblTaxInvoiceHdr] where id='" + lblHiddenid.Text + "'", con);
    //        Object F_Fright = cmdFright.ExecuteScalar();
    //        string FrightValuee = F_Fright.ToString();
    //        if (FrightValuee == "0")
    //        {
    //            //DataTable dt = new DataTable();
    //            SqlDataAdapter sad = new SqlDataAdapter("select * from tblTaxInvoiceDtls where HeaderId='" + lblHiddenid.Text + "'", con);
    //            sad.Fill(dt);
    //        }
    //        else
    //        {
    //            //DataTable dt = new DataTable();
    //            SqlDataAdapter sad = new SqlDataAdapter("select * from VW_EINVTransport where HeaderId='" + lblHiddenid.Text + "'", con);
    //            sad.Fill(dt);
    //        }
    ...
    //            Cmd.Parameters.AddWithValue("@e_way_created_by", Session["name"].ToString());
    //            Cmd.ExecuteNonQuery();
    //            con.Close();
    ...
    protected void GetPDFDetails_EwayBill()
    {
        ...
        if (F_Qrdtl != "")
        {
            ...
            GenerateQR_Eway(EwbNo, "27ATFPS1959J1Z4", EwbDt);
        ...
        try
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    Cmd.Parameters.AddWithValue("@e_way_cancel_by", Session["name"].ToString());
                    Cmd.ExecuteNonQuery();
                    con.Close();
                    ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('E-Way Bill Cancelled Successfully...!!');window.location.href='TaxInvoiceList.aspx';", true);
                }
            }
        }
        catch (Exception ex)
    ...
    protected void EwayPdf()
    {
        ...
        if (Dt.Rows.Count > 0)
        {
            ...
            SqlCommand cmdGethsn = new SqlCommand("select TOP 1 HSN from tblTaxInvoiceDtls where HeaderID='" + lblHiddenid.Text + "'", con);
            ...
            con.Open();
            SqlCommand cmdcheck = new SqlCommand("select StateName from tblStateNameCode where Code='" + toStateCode + "'", con);
            string stateName = cmdcheck.ExecuteScalar().ToString();
        ...
        doc.Close();
        Iframe1.Attributes["src"] = @"../files/" + Docname;
    }
}
