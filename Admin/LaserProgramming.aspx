                                ...
                                <div class="col-md-12" style="padding: 30px;">
                                    <div id="DivRoot" align="left">
                                        ...
                                        <div style="overflow: auto; position: relative; top: 0px; vertical-align: top;"  class="dt-responsive table-responsive" onscroll="OnScrollDiv(this)" id="DivMainContent">
                                            <asp:GridView ID="dgvLaserprogram" runat="server" CssClass="table table-striped table-bordered nowrap"
                                                AutoGenerateColumns="false" DataKeyNames="LaserProgId" OnRowCommand="dgvLaserprogram_RowCommand" Width="100%" OnRowDataBound="dgvLaserprogram_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Select" ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblLaserID" runat="server" Text='<%# Eval("LaserProgId") %>' Visible="false"></asp:Label>
                                                    ...
                                                    <asp:TemplateField HeaderText="Customer Name" ItemStyle-HorizontalAlign="Center" Visible="true">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:TextBox runat="server" ID="lblCustName" ReadOnly="true" TextMode="MultiLine" Rows="4" Width="100%" CssClass="form-control" Text='<%# Eval("CustomerName").ToString().Replace("<br>", " ") %>' style="width: 150px;"></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Size" HeaderStyle-Width="100" ItemStyle-HorizontalAlign="Center" Visible="true">
                                                        <ItemTemplate>
                                                            <asp:TextBox runat="server" ID="lblSize" ReadOnly="true" TextMode="MultiLine" Rows="5" Width="100%" CssClass="form-control" Text='<%# Eval("Size").ToString().Replace("<br>", " ") %>' Style="width: 150px;height: 87px;"></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="OutDtTime" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                        <ItemTemplate>
                    ...
                    <div class="col-md-7">
                        <div class="profilemodel2">
                            <div class="headingcls">
                                ...
                                <button type="button" id="CloseCreatedetail" class="btnclose" style="display: inline-block;" data-dismiss="modal" onclick="window.location='LaserProgramming.aspx';">CANCEL</button></h4>
                            </div>
                            <br />
