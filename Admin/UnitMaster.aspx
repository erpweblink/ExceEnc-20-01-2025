                        ...
                        <div class="col-md-5">
                            <div class="page-header-breadcrumb">
                                <div style="float: right; margin: 3px; margin-bottom: 5px;">
                                    <span><a href="UnitList.aspx" style="font-size: 16px; border: 1px dashed gray; padding: 4px;">&nbsp;Unit List</a>&nbsp;&nbsp;
                                    </span>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-xl-12 col-md-12">
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-2 spancls">Unit Name<i class="reqcls">*&nbsp;</i> : </div>
                                                    <div class="col-md-4">
                                                        <asp:TextBox ID="txtUnitName" CssClass="form-control" runat="server" Width="100%" OnTextChanged="txtUnitName_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="Dynamic" ErrorMessage="Please Enter Unit Name"
                                                            ControlToValidate="txtUnitName" ValidationGroup="form1" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-2">
                                                              <asp:Button ID="btnadd" runat="server" ValidationGroup="form1" CssClass="btn btn-primary" Width="100%" Text="Add Unit" OnClick="btnadd_Click" />
                                                            </div>
                                                            <div class="col-md-2">
