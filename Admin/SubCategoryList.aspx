<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="SubCategoryList.aspx.cs" Inherits="Admin_SubCategoryList" %>
                ...
                <div class="col-md-5">
                    <div class="page-header-breadcrumb">
                        <div style="float: right; margin: 3px; margin-bottom: 5px;">
                            <span id="btnAddSubCategory" runat="server"><a href="SubCategoryMaster.aspx" style="font-size: 16px; border: 1px dashed gray; padding: 4px;">&nbsp;Add SubCategory</a>&nbsp;&nbsp;
                            </span>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div id="DivRoot" align="left">
                                            ...
                                            <div style="overflow: scroll;" class="dt-responsive table-responsive" onscroll="OnScrollDiv(this)" id="DivMainContent">
                                                <asp:GridView ID="GvSubCategory" runat="server"
                                                    ...
                                                    DataKeyNames="id" OnRowCommand="GvSubCategory_RowCommand" AllowPaging="false" ShowHeader="true" PageSize="50">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="SubCategory" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
