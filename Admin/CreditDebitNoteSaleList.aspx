<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="CreditDebitNoteSaleList.aspx.cs" Inherits="Admin_CreditDebitList" %>
                ...
                <div class="col-md-5">
                    <div class="page-header-breadcrumb">
                        <div style="float: right; margin: 3px; margin-bottom: 5px;">
                            ...
                            <span id="btnEinv_CrDbNote" runat="server"><a href="EInv_CrDbNote.aspx" style="font-size: 16px; border: 1px dashed gray; padding: 4px;">&nbsp;Add E-Invoice</a>&nbsp;&nbsp;
                            </span>
                        </div>
                    </div>
                </div>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Credit/Debit no" ItemStyle-HorizontalAlign="Center">
                                                         ...
                                                         <asp:TemplateField HeaderText="Supplier Name">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="linksname" runat="server" Text='<%# Eval("SupplierName") %>'></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
