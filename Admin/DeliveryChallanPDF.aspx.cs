...
public partial class Admin_DeliveryChallanPDF : System.Web.UI.Page
{
    ...
    protected void Pdf(string id)
    {
        ...
        if (Dt.Rows.Count > 0)
        {
            ...
            float[] widths3 = new float[] { 4f, 60f, 11f, 6f, 10f, 6f };
            ...
            if (Dt.Rows.Count > 0)
            {
                ...
                foreach (DataRow dr in Dt.Rows)
                {
                    ...
                    T_Rate += Convert.ToDouble(dr["Rate"].ToString());
            ...
            table.SetWidths(new float[] { 4f, 60f, 11f, 6f, 10f, 6f });
            ...
            table.AddCell(cell2);
            PdfPCell cell113 = new PdfPCell(new Phrase(T_Rate.ToString("#0.00"), FontFactory.GetFont("Arial", 9, Font.BOLD)));
            cell113.HorizontalAlignment = Element.ALIGN_CENTER;
            ...
            PdfPCell cell1151 = new PdfPCell(new Phrase("", FontFactory.GetFont("Arial", 9, Font.NORMAL)));
            cell115.HorizontalAlignment = Element.ALIGN_RIGHT;
            table.AddCell(cell1151);
            doc.Add(table);
