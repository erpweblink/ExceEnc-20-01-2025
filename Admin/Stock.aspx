<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Stock.aspx.cs" Inherits="Admin_Stock" EnableEventValidation="false" %>
    ...
    <script type="text/javascript">   
        ...
        function CheckedCheckbox(ob) {
            ...
            if (checkboxval == true) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'Stock.aspx/MakeSessionNull',
                    data: '{}',
            ...
            var grid = document.getElementById("<%=dgvStock.ClientID%>");
    ...
    <asp:Panel runat="server" ID="pnlContainer">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <div class="page-wrapper">
                            ...
                            <div class="card">
                                ...
                                <div class="row" style="padding: 10px;">
                                    ...
                                    <div class="col-md-2" id="btnshowhide">
                                        <%--<asp:LinkButton ID="btnGetSelected" runat="server" CssClass="btn btn-small btn-primary" OnClick="GetSelectedRecords"><i class="fa fa-truck"></i>&nbsp;Dispatch</asp:LinkButton>--%>

                                        <asp:LinkButton ID="btnGetSelected" runat="server" CssClass="btn btn-small btn-primary" OnClick="GetSelectedRecords" OnClientClick="this.disabled=true; this.innerHTML='Processing...';"><i class="fa fa-truck"></i>&nbsp;Approve & Dispatch</asp:LinkButton>
                                    ...
                                    <div class="col-md-12" style="padding: 30px;">
                                        <div id="DivRoot" align="left">
                                            ...
                                            <div style="overflow: auto; position: relative; top: 0px; vertical-align: top;" class="dt-responsive table-responsive" onscroll="OnScrollDiv(this)" id="DivMainContent">
                                                <asp:GridView ID="dgvStock" runat="server" CssClass="table table-striped table-bordered nowrap"
                                                    AutoGenerateColumns="false" DataKeyNames="SubOA" OnRowDataBound="dgvStock_RowDataBound" OnRowCommand="dgvStock_RowCommand">
                                                    <Columns>
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Select" ItemStyle-HorizontalAlign="Center" Visible="true">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                            <ItemTemplate>
                                                                <a href="<%#string.Format("../Reports/ReportPDF.aspx?Dept="+encrypt("Dispatch")+"&OANumberWise={0}", encrypt(Eval("OANumber").ToString())) %>" target="_blank">
                                                                    <asp:Image ID="ImgPrint" runat="server" CssClass="img1" ImageUrl="../img/Print.png" Height="29px" ToolTip="Print" /></a>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                        <asp:TemplateField HeaderText="Return Qty" ItemStyle-HorizontalAlign="Center" Visible="true">
                                                            <ItemTemplate>
                                                                ...
                                                                &nbsp;&nbsp;
                                                                <asp:LinkButton ID="btnRemark" runat="server" CommandName="RowComment" CommandArgument='<%# Eval("StockId") %>' ToolTip="Add Remark"><i class="fa fa-comment" style="font-size: 25px!important" aria-hidden="true"></i></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                    ...
                    <asp:Panel ID="PnlCreateQuot" runat="server" CssClass="modelprofile1">
                      ...
                      <button type="button" id="CloseCreatedetail" class="btnclose" style="display: inline-block;" data-dismiss="modal" onclick="window.location='Stock.aspx';">CANCEL</button></h4>
                                    </div>
                                    <br />
            ...
            <Triggers>
                ...
                <asp:PostBackTrigger ControlID="dgvStock" />
