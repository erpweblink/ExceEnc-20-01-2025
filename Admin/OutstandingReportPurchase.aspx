<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="OutstandingReportPurchase.aspx.cs" Inherits="OutstandingReportPurchase" %>
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-3 col-md-3">
                                            <asp:TextBox ID="ddltype" runat="server" CssClass="form-control" Width="100%" Text="PURCHASE" ReadOnly="true"></asp:TextBox>
                                        </div>
                                        <div class="col-xl-3 col-md-3">
                                    ...
                                    <div class="row" id="btn" runat="server">
                                        <div class="col-xl-6 col-md-6">
                                            <asp:Button ID="btnexcel" runat="server" ValidationGroup="form1" visible="false" CssClass="btn btn-primary" Text="Export Excel" OnClick="ExportExcel" />
