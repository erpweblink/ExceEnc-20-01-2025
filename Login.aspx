...
<head>
    ...
    <style>
        ...
        .multiclr {
            background: #30bab6;
            background: -webkit-linear-gradient(top, #163a8c, #369469);
                            ...
                            <div class="auth-box card" style="max-width: 385px;">
                                <div class="card-block">
                                    ...
                                    <div class="form-group form-primary">
                                        <asp:TextBox ID="txtemail" runat="server" class="form-control" placeholder="Your Email Address"></asp:TextBox>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <a href="#" target="_blank">
                                                <img src="img/ExcelEncLogo.png" alt="logo" width="130px" /> </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
